...
var TotalIncomeComponent = React.createClass({
  ...
  render: function(){
    ...
    return(
      <div className="row">
        <span className="budget-amount col-xs-2">Total</span>
        <div className="budget-amount col-xs-2">{accounting.formatMoney(totalIncome)}</div>
      </div>
    )
  }
});
...
var TotalExpenseComponent = React.createClass({
  render: function(){
    ...
    return(
      <div className="row">
        <span className="budget-amount col-xs-2">Total</span>
        <div className="budget-amount col-xs-2">{accounting.formatMoney(totalExpense)}</div>
      </div>
    )
  }
});
...
var BudgetReportComponent = React.createClass({
  ...
  //console.log(this.state);
    ...
    return (
        <div className="row">
          <div className="col-md-offset-1 budget-report well col-md-10">
            <h2>Income</h2>
              <div className="row">
